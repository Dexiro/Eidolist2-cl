//#include "MapComparisonObj.h"
//#include "../Transform.h"
//#include "../AssetLoader.h"
//#include "CompileMap.h"
//
//
//MapComparisonObj::MapComparisonObj()
//{
//	for(int i = 0; i < m_mapObjects.
//}
//
//MapComparisonObj::~MapComparisonObj()
//{
//}
//
//void MapComparisonObj::FixedUpdate(SDLContext& context, int frames, double dt)
//{
...
//}
//
//void MapComparisonObj::Draw(SDLContext& context, glm::vec2 pos, glm::vec2 scale)
//{
...
//}
//
//void MapComparisonObj::LoadMap(SDLContext& context, MapData* map_data)
//{
//	m_mapData = map_data;
...
//}
//
//void MapComparisonObj::AddComparisonLayers(SDLContext& context, MapData* compare_data)
//{
...
//}
//
//void MapComparisonObj::CreateDefaultLayerObj(int depth, PTexture texture, std::string tag, EMapLayer layerID)
//{
//	if (texture)
//	{
...
//}
//
//void MapComparisonObj::CreateDefaultLayerObj(int depth, EMapLayer layerID)
//{
...
//}
//
//void MapComparisonObj::AddLayerObject(int depth, PBaseObject obj, std::string tag, EMapLayer layerID)
//{
//	m_layers.push_back(ObjLayer(depth, obj, tag, layerID));
//}
//
//void MapComparisonObj::SortLayers()
//{
...
//}
//
//void MapComparisonObj::CompileMap(SDLContext& context, ProjectData* data)
//{
...
//}
//
//rect::FRect MapComparisonObj::MapRect(glm::vec2 wpos, glm::vec2 wscale)
//{
...
//}
//
//glm::vec2 MapComparisonObj::MapCenter(glm::vec2 wpos, glm::vec2 wscale)
//{
//	rect::FRect rect = MapRect(wpos, wscale);
//	return glm::vec2(rect.x + (rect.w / 2.0f), rect.y + (rect.h / 2.0f));
//}
//
//bool MapComparisonObj::PointCollision(glm::vec2 pos, glm::vec2 wpos, glm::vec2 wscale)
//{
...
//}
//
//bool MapComparisonObj::RectCollision(rect::FRect rect, glm::vec2 wpos, glm::vec2 wscale)
//{
//	rect::FRect mapRect = MapRect(wpos, wscale);
...
//}
//
//bool MapComparisonObj::ShowInfo(SDLContext& context)
//{
